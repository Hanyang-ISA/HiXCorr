...
private:
   ...
   static bool LoadIonsHiXCorr(struct Query *pScoring,
							   map<int, double> *pdTmpRawData,
							   map<int, double> *tmpSepcData,
							   Spectrum mstSpectrum,
							   struct PreprocessStruct *pPre);

   static void GetTopIonsHiXCorr(map< int, double > *pdTmpRawData,
								 struct msdata *pTmpSpData,
								 int iArraySize);

   static bool PreprocessHiXCorr(struct Query *pScoring,
								 Spectrum mstSpectrum,
								 double *pdTmpRawData,
								 double *pdTmpFastXcorrData,
								 double *pdTmpCorrelationData,
